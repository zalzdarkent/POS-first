    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="card-body">
                        <form action="{{ route('settings.update') }}" method="POST">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="company_phone">Nomor Perusahaan <span class="text-danger">*</span></label>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="notification_email">Email Notifikasi <span class="text-danger">*</span></label>
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0">Pengaturan Pesan</h5>
                    </div>
                    <div class="card-body">
