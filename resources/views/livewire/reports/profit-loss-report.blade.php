<div>
    ...
    <div class="row">
        ...
        {{-- Sale Returns --}}
        <div class="col-12 col-lg-4">
            <a href="{{ route('sales-return-report.index') }}" class="text-decoration-none">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-3 d-flex align-items-center">
                        <div class="bg-primary p-3 mfe-3 rounded">
        ...
        {{-- Purchases --}}
        <div class="col-12 col-lg-4">
            <a href="{{ route('purchases-report.index') }}" class="text-decoration-none">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-3 d-flex align-items-center">
                        <div class="bg-primary p-3 mfe-3 rounded">
        ...
        {{-- Purchase Returns --}}
        <div class="col-12 col-lg-4">
            <a href="{{ route('purchases-return-report.index') }}" class="text-decoration-none">
                <div class="card border-0 shadow-sm">
                    <div class="card-body p-3 d-flex align-items-center">
                        <div class="bg-primary p-3 mfe-3 rounded">
